...
$ vulnmap-iac-rules build --entrypoint "<package name>/<function name>"

The generated bundle has the name 'bundle.tar.gz', but a custom name can be provided:
$ vulnmap-iac-rules build -o custom-bundle.tar.gz

See our documentation to learn more: 
https://docs.vulnmap.khulnasoft.com/products/vulnmap-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/bundling-rules
`,
	SilenceUsage: true,
