...
$ vulnmap-iac-rules push <path to generated bundle> --registry <desired location of OCI artifact in your OCI registry>
...
$ vulnmap-iac-rules push bundle.tar.gz --registry docker.io/example/bundle

Once the bundle has been pushed to an OCI registry, the Vulnmap IaC CLI can be configured to pull it down for scanning:
$ vulnmap config set oci-registry-url=https://registry-1.docker.io/example/bundle:latest
$ vulnmap config set oci-registry-username=username
$ vulnmap config set oci-registry-password=password

See our documentation to learn more: 
https://docs.vulnmap.khulnasoft.com/products/vulnmap-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/pushing-a-bundle
`,
	SilenceUsage: true,
