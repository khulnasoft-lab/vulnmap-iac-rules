...
$ vulnmap-iac-rules parse test.tf --format hcl2
...
$ vulnmap-iac-rules parse test.yaml --format yaml
...
$ vulnmap-iac-rules parse tf-plan.json --format tf-plan

See our documentation to learn more: 
https://docs.vulnmap.khulnasoft.com/products/vulnmap-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/parsing-an-input-file
`,
	SilenceUsage: true,
