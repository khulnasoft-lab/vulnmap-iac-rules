...
$ vulnmap-iac-rules test --run test_<rule>
...
https://docs.vulnmap.khulnasoft.com/products/vulnmap-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/testing-a-rule
`,
	SilenceUsage:  true,
	SilenceErrors: true,
