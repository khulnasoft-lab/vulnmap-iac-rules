...
$ vulnmap-iac-rules template --rule <rule> --format <format>
...
- 'title': rule identifier in the vulnmap CLI
...
https://docs.vulnmap.khulnasoft.com/products/vulnmap-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/writing-a-rule
...
`,
	...
	PreRunE: func(cmd *cobra.Command, args []string) error {
		...
		// make sure rule name doesn't belong to Vulnmap namespace
		if strings.HasPrefix(templateParams.RuleID, "VULNMAP-") {
			return fmt.Errorf("Rule name cannot start with \"VULNMAP-\"")
		}
