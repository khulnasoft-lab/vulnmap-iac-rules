...
Describe 'Contract test between the SDK and the Vulnmap CLI'
    Describe 'Via --rules flag'
        ...
        It 'Verifies custom rule without a path'
            vulnmap_iac_test() {
                ...
                # create a basic rule
                ../vulnmap-iac-rules template --rule CONTRACT --format hcl2
                ...
                vulnmap iac test --rules=./bundle.tar.gz ./rules/CONTRACT/fixtures/denied.tf
                echo $?
            }

            When call vulnmap_iac_test
        ...
        It 'Verifies custom rule with relative path'
            vulnmap_iac_test() {
                # create a basic rule
                ./vulnmap-iac-rules template ./tmp --rule CONTRACT --format hcl2
                ...
                # run tests and make sure they pass
                ./vulnmap-iac-rules test ./tmp 

                # create bundle
                ./vulnmap-iac-rules build ./tmp --ignore "testing" --ignore "*_test.rego"

                # authenticate with Vulnmap
                vulnmap auth $VULNMAP_TOKEN

                # use bundle with Vulnmap
                vulnmap iac test --rules=./bundle.tar.gz ./tmp/rules/CONTRACT/fixtures/denied.tf
                echo $?
            }
    ...
    Describe 'Via push and pull'
        ...
        BeforeEach setupTmp
        AfterEach cleanupTmp
        It 'verifies contract between the SDK and Vulnmap'
            vulnmap_iac_test() {
                cd tmp
                ...
                # push bundle
                ../vulnmap-iac-rules push --registry $OCI_REGISTRY_NAME-$OS bundle.tar.gz
