...
Describe './vulnmap-iac-rules template --help'
   It 'returns passing test status'
      When call ./vulnmap-iac-rules template --help
      The status should be success
      The output should include 'Usage:
  vulnmap-iac-rules template [path] [flags]
...
Describe './vulnmap-iac-rules template ./fixtures/custom-rules --format hcl2'
   It 'returns an error'
      When call ./vulnmap-iac-rules template ./fixtures/custom-rules --format hcl2
      The status should be failure
      The stderr should include 'required flag(s) "rule" not set'
   End
End

Describe './vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST'
   It 'returns  an error'
      When call ./vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST
      The status should be failure
      The stderr should include 'required flag(s) "format" not set'
   End
End

Describe './vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST --format fake'
   It 'returns  an error'
      When call ./vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST --format fake
      The status should be failure
      The stderr should include 'invalid argument "fake" for "-f, --format" flag'
   End
End

Describe './vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST1 --format hcl2'
   It 'generates the template'
      When call ./vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST1 --format hcl2
      The status should be success
...
Describe './vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST2 --format json'
   It 'generates the template'
      When call ./vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST2 --format json
      The status should be success
      The output should include 'Template rules directory'
...
Describe './vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST3 --format yaml'
   It 'returns passing test status'
      When call ./vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST3 --format yaml
      The status should be success
      The output should include 'Template rules directory'
...
Describe './vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST4 --format tf-plan'
   It 'returns passing test status'
      When call ./vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST4 --format tf-plan
      The status should be success
      The output should include 'Template rules directory'
...
Describe './vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST4'
   It 'returns passing test status'
      ./vulnmap-iac-rules template ./fixtures/custom-rules --rule TEST4 --format tf-plan
